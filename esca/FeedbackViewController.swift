...
class FeedbackViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func addFeedback() {
        self.performSegue(withIdentifier: "addFeedbackFromList", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "addFeedbackFromList" {
            let vc = segue.destination as! AddFeedbackViewController
            vc.dealKey = dealKey
        }
    }
